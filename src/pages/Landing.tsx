  ...
  return <div className="min-h-screen bg-black text-white">
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Button size="lg" onClick={() => navigate('/signup')} className="bg-[#0400ff] hover:bg-[#0300cc] px-8 py-4 text-lg font-medium text-slate-50">
                Get Started →
              </Button>
              <Button variant="outline" size="lg" className="bg-black border-white text-white hover:bg-gray-900 px-8 py-4 text-lg font-medium" onClick={() => navigate('/login')}>
                Sign In
              </Button>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" className="bg-[#0400ff] hover:bg-[#0300cc] text-white px-12 py-4 text-lg font-medium" onClick={() => navigate('/signup')}>
