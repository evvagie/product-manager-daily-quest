    ...
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        {selectedCategory && selectedDifficulty && (
          <Card className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 border-blue-800 mb-8">
            <CardHeader>
            ...
            <CardContent>
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">4 interactive challenges • ~15 minutes</p>
                </div>
