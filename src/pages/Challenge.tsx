  ...
  const challenges: ChallengeData[] = [
    {
      ...
      content: {
        features: [
          { id: 'f1', name: 'User Authentication', impact: 'high', effort: 'medium' },
          { id: 'f2', name: 'Push Notifications', impact: 'medium', effort: 'low' },
          { id: 'f3', name: 'Advanced Analytics', impact: 'high', effort: 'high' },
          { id: 'f4', name: 'Dark Mode', impact: 'low', effort: 'low' },
          { id: 'f5', name: 'API Integration', impact: 'high', effort: 'high' }
        ]
      },
      timeLimit: 180
    },
    {
      ...
      content: {
        ...
        options: [
          { id: 'a', text: 'Immediately add more servers', impact: 'Quick fix but expensive' },
          { id: 'b', text: 'Optimize existing code first', impact: 'Takes time but cost-effective' },
          { id: 'c', text: 'Ignore feedback and focus on new features', impact: 'Risky for user satisfaction' },
          { id: 'd', text: 'Conduct performance audit first', impact: 'Data-driven but takes time' }
        ]
      },
      timeLimit: 120
    },
    {
      ...
      content: {
        stakeholders: [
          { id: 's1', name: 'CEO', role: 'Sets company vision' },
          { id: 's2', name: 'Lead Developer', role: 'Implementation feasibility' },
          { id: 's3', name: 'Marketing Manager', role: 'User acquisition' },
          { id: 's4', name: 'Customer Support', role: 'User pain points' },
          { id: 's5', name: 'Sales Team', role: 'Revenue impact' }
        ]
      },
      timeLimit: 150
    },
    {
      ...
      content: {
        ...
        options: [
          { id: 'o1', strategy: 'Full Launch', description: 'Release to all users immediately', pros: ['Maximum impact', 'Quick feedback'], cons: ['High risk if bugs exist', 'Support overload'] },
          { id: 'o2', strategy: 'Beta Testing', description: 'Release to 10% of users first', pros: ['Controlled rollout', 'Early feedback'], cons: ['Slower adoption', 'Complex rollback'] },
          { id: 'o3', strategy: 'Premium First', description: 'Launch to paid users only', pros: ['Revenue impact', 'Loyal user feedback'], cons: ['Limited reach', 'May create inequality'] }
        ]
      },
      timeLimit: 200
    }
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="p-4 bg-gray-800 rounded-lg">
                      ...
                      <p className="text-gray-400 text-sm">Total estimated time</p>
                    </div>
                    <div className="p-4 bg-gray-800 rounded-lg">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-between">
            ...
            <Button 
              ...
              onClick={handleNext}
              disabled={!answers[currentChallenge]}
            >
      ...
      <div className="space-y-2">
        {orderedFeatures.map((feature: any, index: number) => (
          <div
            ...
            className="p-4 bg-gray-800 rounded-lg border border-gray-700 cursor-move hover:border-gray-600 transition-colors"
          >
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {rankedStakeholders.map((stakeholder: any, index: number) => (
          <div key={stakeholder.id} className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
