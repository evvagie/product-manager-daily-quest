          ...
          <div className="space-y-3">
            {loading ? (
              <div className="animate-pulse">
                <div className="flex items-center space-x-3 p-3 bg-white/30 rounded-lg border border-white/40">
              ...
              recentAchievements.map((achievement) => (
                <div key={achievement.achievement_id} className="flex items-center space-x-3 p-3 bg-white/30 rounded-lg border border-white/40 bg-gradient-to-r from-blue-500/10 to-purple-500/10">
              ...
              <div className="flex items-center space-x-3 p-3 bg-white/25 rounded-lg border-2 border-dashed border-white/40">
